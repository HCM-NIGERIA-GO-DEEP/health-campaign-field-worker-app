...
part 'clf_location.dart';
part 'clf_details.dart';
...
final clfLocationShowCaseData = _CLFLocationShowcaseData();
final householdDetailsShowcaseData = _HouseholdDetailsShowcaseData();
final clfDetailsShowcaseData = _CLFDetailsShowcaseData();
