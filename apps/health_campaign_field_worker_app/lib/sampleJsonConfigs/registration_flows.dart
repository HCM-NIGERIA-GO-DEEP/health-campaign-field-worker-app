            ...
            "children": [
              {
                ...
                "children": [
                  ...
                  },
                  {
                    ...
                    "format": "button",
                    "visible":
                        "{{fn:isClosedHousehold(item.tasks)}} == true && {{fn:hasStockForRegistration()}}==false",
                    "onAction": [
                      {
                        "actions": [
                          {
                      ...
                      },
                      {
                        ...
                        "condition": {
                          "expression":
                              "{{fn:isClosedHousehold(item.tasks)}} == false"
                        }
                      },
                      {
                  ...
                  },
                  {
                    ...
                    "format": "button",
                    "visible":
                        "{{fn:isClosedHousehold(item.tasks)}} == true && {{fn:hasStockForRegistration()}}==true",
                    "onAction": [
                      {
                        ...
                        "actions": [
                          {
                            "actionType":
                                "REVERSE_TRANSFORM", // ← PRESENT at line 2087
                            "properties": {
                              "data": [
                                {"key": "entities", "value": "{{item}}"}
                              ],
                  ...
                  },
                  {
                    ...
                    "format": "button",
                    "visible":
                        "{{fn:isClosedHousehold(item.tasks)}} == false && {{fn:hasStockForRegistration()}}==true",
                    "onAction": [
                      {
                        // ITN Delivered -> household overview (read-only preview)
                        "actions": [
                  ...
                  },
                  {
                    ...
                    "format": "actionPopup",
                    "visible":
                        "{{fn:isClosedHousehold(item.tasks)}} == false && {{fn:hasStockForRegistration()}}==false",
                    "onAction": [],
                    "fieldName": "openMemberCard",
                    "properties": {
                      "size": "medium",
      ...
      "pages": [
        {
          ...
          "navigateTo": {
            "data": [
              ...
              {
                "key": "selectedIndividualAgeInMonths",
                "value": "{{fn:formatDate(formData, 'ageinmonths')}}"
              },
            ...
            "children": [
              {
                ...
                "children": [
                  ...
                  //   "type": "template",
                  //   "label": "OPEN",
                  //   "visible": "{{fn:isClosedHousehold(item.tasks)}} == true && {{fn:hasStockForRegistration()}}==false",
                  //   "format": "button",
                  //   "onAction": [
                  //     {
                  //       "actions": [
                  ...
                  //   "type": "template",
                  //   "label": "OPEN",
                  //   "visible": "{{fn:isClosedHousehold(item.tasks)}} == true && {{fn:hasStockForRegistration()}}==true",
                  //   "format": "button",
                  //   "onAction": [
                  //     {
                  //       "actions": [
                  ...
                  //   "label": "OPEN",
                  //   "format": "button",
                  //   "visible": "{{fn:isClosedHousehold(item.tasks)}} == false && {{fn:hasStockForRegistration()}}==true",
                  //   "onAction": [
                  //     {
                  //       "actions": [
                  //         {
                  ...
                  //   "label": "OPEN",
                  //   "format": "actionPopup",
                  //   "visible": "{{fn:isClosedHousehold(item.tasks)}} == false && {{fn:hasStockForRegistration()}}==false",
                  //   "onAction": [],
                  //   "fieldName": "openMemberCard",
                  //   "properties": {
                  //     "size": "medium",
      ...
      "pages": [
        {
          ...
          "onAction": [
            ...
            //                 "properties": {
            //                   "message":
            //                       "Failed to fetch config for bulk delivery."
            //                 }
            //               }
            //             ],
            //             "configName": "indirectBulkDelivery"
