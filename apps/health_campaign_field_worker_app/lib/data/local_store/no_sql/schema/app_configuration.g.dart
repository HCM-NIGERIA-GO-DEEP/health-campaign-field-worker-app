...
const AppConfigurationSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'BOUNDARY_RELATIONSHIP': PropertySchema(
      id: 5,
      name: r'BOUNDARY_RELATIONSHIP',
      type: IsarType.objectList,
      target: r'BoundaryRelationshipConfig',
    ),
    ...
    r'DEVICE_CHANGE_REASONS': PropertySchema(
      id: 10,
      name: r'DEVICE_CHANGE_REASONS',
      type: IsarType.objectList,
      target: r'DeviceChangeReasons',
    ),
  ...
  embeddedSchemas: {
    ...
    r'BeneficiaryIdConfig': BeneficiaryIdConfigSchema,
    r'IdTypeOptions': IdTypeOptionsSchema,
    r'RelationShipTypeOptions': RelationShipTypeOptionsSchema,
    ...
    r'TransitPostType': TransitPostTypeSchema,
    r'DeviceChangeReasons': DeviceChangeReasonsSchema,
    r'SingleUserLogin': SingleUserLoginSchema,
    r'ReferralReasons': ReferralReasonsSchema,
    r'ManualAttendanceReasons': ManualAttendanceReasonsSchema,
...
int _appConfigurationEstimateSize(
  ...
  {
    final list = object.beneficiaryIdConfig;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[BeneficiaryIdConfig]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += BeneficiaryIdConfigSchema.estimateSize(
  ...
  {
    final list = object.boundaryRelationship;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[BoundaryRelationshipConfig]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += BoundaryRelationshipConfigSchema.estimateSize(
              value, offsets, allOffsets);
        }
      }
    }
  ...
  {
    final list = object.deviceChangeReasons;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[DeviceChangeReasons]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += DeviceChangeReasonsSchema.estimateSize(
              value, offsets, allOffsets);
        }
      }
    }
  ...
  {
    final list = object.relationShipTypeOptions;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[RelationShipTypeOptions]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += RelationShipTypeOptionsSchema.estimateSize(
              value, offsets, allOffsets);
        }
      }
    }
  ...
  {
    final list = object.singleUserLogin;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[SingleUserLogin]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount +=
              SingleUserLoginSchema.estimateSize(value, offsets, allOffsets);
        }
      }
    }
  }
  ...
  {
    final list = object.transitPostType;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[TransitPostType]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount +=
              TransitPostTypeSchema.estimateSize(value, offsets, allOffsets);
        }
      }
    }
  }
  ...
  {
    final list = object.manualAttendanceReasons;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[ManualAttendanceReasons]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += ManualAttendanceReasonsSchema.estimateSize(
              value, offsets, allOffsets);
        }
      }
    }
...
void _appConfigurationSerialize(
  ...
  writer.writeObjectList<BoundaryRelationshipConfig>(
    offsets[5],
    allOffsets,
    BoundaryRelationshipConfigSchema.serialize,
    object.boundaryRelationship,
  );
  ...
  writer.writeObjectList<DeviceChangeReasons>(
    offsets[10],
    allOffsets,
    DeviceChangeReasonsSchema.serialize,
    object.deviceChangeReasons,
  );
  writer.writeObjectList<BandwidthBatchSize>(
    offsets[11],
    allOffsets,
...
AppConfiguration _appConfigurationDeserialize(
  ...
  object.boundaryRelationship =
      reader.readObjectList<BoundaryRelationshipConfig>(
    offsets[5],
    BoundaryRelationshipConfigSchema.deserialize,
    allOffsets,
    BoundaryRelationshipConfig(),
  );
  ...
  object.deviceChangeReasons = reader.readObjectList<DeviceChangeReasons>(
    offsets[10],
    DeviceChangeReasonsSchema.deserialize,
    allOffsets,
    DeviceChangeReasons(),
  );
...
P _appConfigurationDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readObjectList<BoundaryRelationshipConfig>(
        offset,
        BoundaryRelationshipConfigSchema.deserialize,
        allOffsets,
        BoundaryRelationshipConfig(),
    ...
    case 10:
      return (reader.readObjectList<DeviceChangeReasons>(
        offset,
        DeviceChangeReasonsSchema.deserialize,
        allOffsets,
        DeviceChangeReasons(),
...
extension AppConfigurationQueryFilter
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      beneficiaryIdConfigIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'BENEFICIARY_ID_CONFIG',
      ));
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      beneficiaryIdConfigIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'BENEFICIARY_ID_CONFIG',
      ));
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      beneficiaryIdConfigLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'BENEFICIARY_ID_CONFIG',
        length,
        true,
        length,
        true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      beneficiaryIdConfigLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      beneficiaryIdConfigLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      beneficiaryIdConfigLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'BOUNDARY_RELATIONSHIP',
      ));
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'BOUNDARY_RELATIONSHIP',
      ));
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'BOUNDARY_RELATIONSHIP',
        length,
        true,
        length,
        true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'BOUNDARY_RELATIONSHIP',
        0,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      deviceChangeReasonsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'DEVICE_CHANGE_REASONS',
      ));
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      deviceChangeReasonsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'DEVICE_CHANGE_REASONS',
      ));
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      deviceChangeReasonsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'DEVICE_CHANGE_REASONS',
        length,
        true,
        length,
        true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      deviceChangeReasonsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      deviceChangeReasonsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      deviceChangeReasonsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'HOUSEHOLD_MEMBER_RELATIONSHIP_TYPES',
      ));
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'HOUSEHOLD_MEMBER_RELATIONSHIP_TYPES',
      ));
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'HOUSEHOLD_MEMBER_RELATIONSHIP_TYPES',
        length,
        true,
        length,
        true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'HOUSEHOLD_MEMBER_RELATIONSHIP_TYPES',
        0,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'HOUSEHOLD_MEMBER_RELATIONSHIP_TYPES',
        0,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      singleUserLoginIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'SINGLE_USER_LOGIN',
      ));
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      singleUserLoginIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'SINGLE_USER_LOGIN',
      ));
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      singleUserLoginLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'SINGLE_USER_LOGIN',
        length,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      singleUserLoginLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      transitPostTypeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'TRANSIT_POST_TYPE',
      ));
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      transitPostTypeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'TRANSIT_POST_TYPE',
      ));
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      transitPostTypeLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'TRANSIT_POST_TYPE',
        length,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      transitPostTypeLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'manualAttendanceReasons',
      ));
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'manualAttendanceReasons',
      ));
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'manualAttendanceReasons',
        length,
        true,
        length,
        true,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'manualAttendanceReasons',
        0,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'manualAttendanceReasons',
        0,
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AppConfigurationQueryObject
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      beneficiaryIdConfigElement(FilterQuery<BeneficiaryIdConfig> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'BENEFICIARY_ID_CONFIG');
    });
  }

  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      boundaryRelationshipElement(FilterQuery<BoundaryRelationshipConfig> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'BOUNDARY_RELATIONSHIP');
    });
  }
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      deviceChangeReasonsElement(FilterQuery<DeviceChangeReasons> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'DEVICE_CHANGE_REASONS');
    });
  }
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      relationShipTypeOptionsElement(FilterQuery<RelationShipTypeOptions> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'HOUSEHOLD_MEMBER_RELATIONSHIP_TYPES');
    });
  }
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      singleUserLoginElement(FilterQuery<SingleUserLogin> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'SINGLE_USER_LOGIN');
    });
  }
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterFilterCondition>
      manualAttendanceReasonsElement(FilterQuery<ManualAttendanceReasons> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'manualAttendanceReasons');
    });
  }
...
extension AppConfigurationQueryProperty
  ...
  QueryBuilder<AppConfiguration, List<BeneficiaryIdConfig>?, QQueryOperations>
  ...
  QueryBuilder<AppConfiguration, List<BoundaryRelationshipConfig>?,
      QQueryOperations> boundaryRelationshipProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'BOUNDARY_RELATIONSHIP');
    });
  }
  ...
  QueryBuilder<AppConfiguration, List<DeviceChangeReasons>?, QQueryOperations>
      deviceChangeReasonsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'DEVICE_CHANGE_REASONS');
    });
  }
  ...
  QueryBuilder<AppConfiguration, List<RelationShipTypeOptions>?,
      QQueryOperations> relationShipTypeOptionsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'HOUSEHOLD_MEMBER_RELATIONSHIP_TYPES');
    });
  }
  ...
  QueryBuilder<AppConfiguration, List<SingleUserLogin>?, QQueryOperations>
  ...
  QueryBuilder<AppConfiguration, List<TransitPostType>?, QQueryOperations>
      transitPostTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'TRANSIT_POST_TYPE');
    });
  }
  ...
  QueryBuilder<AppConfiguration, List<ManualAttendanceReasons>?,
      QQueryOperations> manualAttendanceReasonsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'manualAttendanceReasons');
    });
  }
...
const RelationShipTypeOptionsSchema = Schema(
  name: r'RelationShipTypeOptions',
  id: 8402199533987303215,
  properties: {
  ...
  estimateSize: _relationShipTypeOptionsEstimateSize,
  serialize: _relationShipTypeOptionsSerialize,
  deserialize: _relationShipTypeOptionsDeserialize,
  deserializeProp: _relationShipTypeOptionsDeserializeProp,
);

int _relationShipTypeOptionsEstimateSize(
  RelationShipTypeOptions object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _relationShipTypeOptionsSerialize(
  RelationShipTypeOptions object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
RelationShipTypeOptions _relationShipTypeOptionsDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = RelationShipTypeOptions();
...
P _relationShipTypeOptionsDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension RelationShipTypeOptionsQueryFilter on QueryBuilder<
    RelationShipTypeOptions, RelationShipTypeOptions, QFilterCondition> {
  QueryBuilder<RelationShipTypeOptions, RelationShipTypeOptions,
...
extension RelationShipTypeOptionsQueryObject on QueryBuilder<
    RelationShipTypeOptions, RelationShipTypeOptions, QFilterCondition> {}
...
const BeneficiaryIdConfigSchema = Schema(
  name: r'BeneficiaryIdConfig',
  id: -7232122141476983245,
  properties: {
    r'BATCH_SIZE': PropertySchema(
      id: 0,
      name: r'BATCH_SIZE',
    ...
    r'MIN_COUNT': PropertySchema(
      id: 1,
      name: r'MIN_COUNT',
      type: IsarType.double,
    )
  },
  estimateSize: _beneficiaryIdConfigEstimateSize,
  serialize: _beneficiaryIdConfigSerialize,
  deserialize: _beneficiaryIdConfigDeserialize,
  deserializeProp: _beneficiaryIdConfigDeserializeProp,
);

int _beneficiaryIdConfigEstimateSize(
  BeneficiaryIdConfig object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _beneficiaryIdConfigSerialize(
  BeneficiaryIdConfig object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeLong(offsets[0], object.batchSize);
  writer.writeDouble(offsets[1], object.minCount);
}

BeneficiaryIdConfig _beneficiaryIdConfigDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = BeneficiaryIdConfig();
  object.batchSize = reader.readLong(offsets[0]);
  object.minCount = reader.readDouble(offsets[1]);
  return object;
}

P _beneficiaryIdConfigDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension BeneficiaryIdConfigQueryFilter on QueryBuilder<BeneficiaryIdConfig,
    BeneficiaryIdConfig, QFilterCondition> {
  QueryBuilder<BeneficiaryIdConfig, BeneficiaryIdConfig, QAfterFilterCondition>
      batchSizeEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'BATCH_SIZE',
...
extension BeneficiaryIdConfigQueryObject on QueryBuilder<BeneficiaryIdConfig,
    BeneficiaryIdConfig, QFilterCondition> {}
...
const BackgroundServiceConfigSchema = Schema(
  ...
  properties: {
    ...
    r'RANDOM_INTERVAL_OFFSET': PropertySchema(
      id: 2,
      name: r'RANDOM_INTERVAL_OFFSET',
      type: IsarType.long,
    ),
...
void _backgroundServiceConfigSerialize(
  ...
  writer.writeLong(offsets[2], object.randomIntervalOffset);
  writer.writeLong(offsets[3], object.serviceInterval);
}
...
BackgroundServiceConfig _backgroundServiceConfigDeserialize(
  ...
  object.randomIntervalOffset = reader.readLongOrNull(offsets[2]);
  object.serviceInterval = reader.readLongOrNull(offsets[3]);
  return object;
}
...
extension BackgroundServiceConfigQueryFilter on QueryBuilder<
  ...
  QueryBuilder<BackgroundServiceConfig, BackgroundServiceConfig,
      QAfterFilterCondition> randomIntervalOffsetIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'RANDOM_INTERVAL_OFFSET',
      ));
    });
  }

  QueryBuilder<BackgroundServiceConfig, BackgroundServiceConfig,
      QAfterFilterCondition> randomIntervalOffsetIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'RANDOM_INTERVAL_OFFSET',
      ));
  ...
  QueryBuilder<BackgroundServiceConfig, BackgroundServiceConfig,
      QAfterFilterCondition> randomIntervalOffsetEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'RANDOM_INTERVAL_OFFSET',
        value: value,
  ...
  QueryBuilder<BackgroundServiceConfig, BackgroundServiceConfig,
      QAfterFilterCondition> randomIntervalOffsetGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<BackgroundServiceConfig, BackgroundServiceConfig,
      QAfterFilterCondition> randomIntervalOffsetLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<BackgroundServiceConfig, BackgroundServiceConfig,
      QAfterFilterCondition> randomIntervalOffsetBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
const TransitPostTypeSchema = Schema(
  name: r'TransitPostType',
  id: -6140441036475819209,
  properties: {
    r'active': PropertySchema(
      id: 0,
      name: r'active',
  ...
  estimateSize: _transitPostTypeEstimateSize,
  serialize: _transitPostTypeSerialize,
  deserialize: _transitPostTypeDeserialize,
  deserializeProp: _transitPostTypeDeserializeProp,
);

int _transitPostTypeEstimateSize(
  TransitPostType object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _transitPostTypeSerialize(
  TransitPostType object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
TransitPostType _transitPostTypeDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = TransitPostType();
  object.active = reader.readBool(offsets[0]);
  object.code = reader.readString(offsets[1]);
  object.name = reader.readString(offsets[2]);
  return object;
...
P _transitPostTypeDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension TransitPostTypeQueryFilter
    on QueryBuilder<TransitPostType, TransitPostType, QFilterCondition> {
  QueryBuilder<TransitPostType, TransitPostType, QAfterFilterCondition>
...
extension TransitPostTypeQueryObject
    on QueryBuilder<TransitPostType, TransitPostType, QFilterCondition> {}

// coverage:ignore-file
// ignore_for_file: duplicate_ignore, non_constant_identifier_names, constant_identifier_names, invalid_use_of_protected_member, unnecessary_cast, prefer_const_constructors, lines_longer_than_80_chars, require_trailing_commas, inference_failure_on_function_invocation, unnecessary_parenthesis, unnecessary_raw_strings, unnecessary_null_checks, join_return_with_assignment, prefer_final_locals, avoid_js_rounded_ints, avoid_positional_boolean_parameters, always_specify_types

const DeviceChangeReasonsSchema = Schema(
  name: r'DeviceChangeReasons',
  id: -302646620529582328,
  properties: {
    r'code': PropertySchema(
      id: 0,
      name: r'code',
  ...
  estimateSize: _deviceChangeReasonsEstimateSize,
  serialize: _deviceChangeReasonsSerialize,
  deserialize: _deviceChangeReasonsDeserialize,
  deserializeProp: _deviceChangeReasonsDeserializeProp,
);

int _deviceChangeReasonsEstimateSize(
  DeviceChangeReasons object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _deviceChangeReasonsSerialize(
  DeviceChangeReasons object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
DeviceChangeReasons _deviceChangeReasonsDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = DeviceChangeReasons();
  object.code = reader.readString(offsets[0]);
  object.name = reader.readString(offsets[1]);
  return object;
}

P _deviceChangeReasonsDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension DeviceChangeReasonsQueryFilter on QueryBuilder<DeviceChangeReasons,
    DeviceChangeReasons, QFilterCondition> {
  QueryBuilder<DeviceChangeReasons, DeviceChangeReasons, QAfterFilterCondition>
      codeEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
...
extension DeviceChangeReasonsQueryObject on QueryBuilder<DeviceChangeReasons,
    DeviceChangeReasons, QFilterCondition> {}

// coverage:ignore-file
// ignore_for_file: duplicate_ignore, non_constant_identifier_names, constant_identifier_names, invalid_use_of_protected_member, unnecessary_cast, prefer_const_constructors, lines_longer_than_80_chars, require_trailing_commas, inference_failure_on_function_invocation, unnecessary_parenthesis, unnecessary_raw_strings, unnecessary_null_checks, join_return_with_assignment, prefer_final_locals, avoid_js_rounded_ints, avoid_positional_boolean_parameters, always_specify_types

const SingleUserLoginSchema = Schema(
  name: r'SingleUserLogin',
  id: 6672778267106634477,
  properties: {
  ...
  estimateSize: _singleUserLoginEstimateSize,
  serialize: _singleUserLoginSerialize,
  deserialize: _singleUserLoginDeserialize,
  deserializeProp: _singleUserLoginDeserializeProp,
);

int _singleUserLoginEstimateSize(
  SingleUserLogin object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _singleUserLoginSerialize(
  SingleUserLogin object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
SingleUserLogin _singleUserLoginDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = SingleUserLogin();
  object.enabled = reader.readBool(offsets[0]);
  object.id = reader.readLong(offsets[1]);
  return object;
}

P _singleUserLoginDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension SingleUserLoginQueryFilter
    on QueryBuilder<SingleUserLogin, SingleUserLogin, QFilterCondition> {
  QueryBuilder<SingleUserLogin, SingleUserLogin, QAfterFilterCondition>
...
extension SingleUserLoginQueryObject
    on QueryBuilder<SingleUserLogin, SingleUserLogin, QFilterCondition> {}
...
const ManualAttendanceReasonsSchema = Schema(
  name: r'ManualAttendanceReasons',
  id: -5832127857525871427,
  properties: {
    r'active': PropertySchema(
      id: 0,
      name: r'active',
  ...
  estimateSize: _manualAttendanceReasonsEstimateSize,
  serialize: _manualAttendanceReasonsSerialize,
  deserialize: _manualAttendanceReasonsDeserialize,
  deserializeProp: _manualAttendanceReasonsDeserializeProp,
);

int _manualAttendanceReasonsEstimateSize(
  ManualAttendanceReasons object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _manualAttendanceReasonsSerialize(
  ManualAttendanceReasons object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
ManualAttendanceReasons _manualAttendanceReasonsDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ManualAttendanceReasons();
  object.active = reader.readBool(offsets[0]);
  object.code = reader.readString(offsets[1]);
  object.name = reader.readString(offsets[2]);
  return object;
...
P _manualAttendanceReasonsDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension ManualAttendanceReasonsQueryFilter on QueryBuilder<
    ManualAttendanceReasons, ManualAttendanceReasons, QFilterCondition> {
  QueryBuilder<ManualAttendanceReasons, ManualAttendanceReasons,
      QAfterFilterCondition> activeEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'active',
...
extension ManualAttendanceReasonsQueryObject on QueryBuilder<
    ManualAttendanceReasons, ManualAttendanceReasons, QFilterCondition> {}
...
const BoundaryRelationshipConfigSchema = Schema(
  name: r'BoundaryRelationshipConfig',
  id: -832480933169515048,
  properties: {
  ...
  estimateSize: _boundaryRelationshipConfigEstimateSize,
  serialize: _boundaryRelationshipConfigSerialize,
  deserialize: _boundaryRelationshipConfigDeserialize,
  deserializeProp: _boundaryRelationshipConfigDeserializeProp,
);

int _boundaryRelationshipConfigEstimateSize(
  BoundaryRelationshipConfig object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _boundaryRelationshipConfigSerialize(
  BoundaryRelationshipConfig object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeString(offsets[3], object.parentBoundaryType);
}

BoundaryRelationshipConfig _boundaryRelationshipConfigDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = BoundaryRelationshipConfig();
  ...
  object.parentBoundaryType = reader.readString(offsets[3]);
  return object;
}

P _boundaryRelationshipConfigDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension BoundaryRelationshipConfigQueryFilter on QueryBuilder<
    BoundaryRelationshipConfig, BoundaryRelationshipConfig, QFilterCondition> {
  QueryBuilder<BoundaryRelationshipConfig, BoundaryRelationshipConfig,
