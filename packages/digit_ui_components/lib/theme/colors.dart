...
class DigitColors {
  ...
  Color get shadowColor => const Color.fromRGBO(0, 112, 60, 0.25);
  Color get darkprimary1 => const Color(0xFF006C3A);
...
class Light {
  ...
  /// Primary
  Color get primary1 => const Color(0xFF00703C);
  Color get primary1Bg => const Color(0xFFEAF7EF);
  Color get primary2 => const Color(0xFF005A32);
