...
class DigitDarkColorTheme extends DigitColorTheme {
  const DigitDarkColorTheme({
    ...
    Paper paper = const Paper(
      ...
      secondary: Color(
          0xFF1E1E1E), // Slightly lighter dark background for secondary paper
    ),
    ...
    Primary primary = const Primary(
      primary1: Color(0xFF008A57), // Darker orange for primary1
      primary2: Color.fromARGB(255, 123, 182, 160), // Darker green for primary2
