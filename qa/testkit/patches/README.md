...
Patch 08 (same vendored-package note as patch 05 applies to its
`digit_text_area_form_input.dart` half):

```
git checkout -- packages/digit_ui_components/lib/widgets/atoms/digit_text_area_form_input.dart
git checkout -- packages/digit_forms_engine/lib/widgets/text_area_builder.dart
rm packages/digit_ui_components/test/widgets/atoms/text_area_input_identifier_test.dart
```
