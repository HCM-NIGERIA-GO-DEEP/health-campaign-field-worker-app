...
**+59 / −32** with them applied (measured 2026-09-03, same 32 failures either
way). Prove any new red is yours the same way: `git stash push -- <the lib
